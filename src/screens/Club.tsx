...
export function Club() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full font-sans text-sm pb-12 overflow-y-auto">
      <div className="bg-gradient-to-r from-[#111111] to-[#161616] rounded-xl p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-5 relative z-10">
          <TeamLogo
            ...
            size={68}
            className="flex-shrink-0 bg-[#0d0d0d] p-3 rounded-xl border border-white/10"
          />
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest bg-blue-500/10 border border-blue-500/30 text-blue-400 px-2.5 py-1 rounded-md">
        ...
        {clubFinances && (
          <div className="glass-panel p-4 rounded-xl text-right">
            ...
            <div className={`text-[10px] font-bold uppercase mt-1 ${clubFinances.financialHealth === 'Rich' ? 'text-emerald-400' : 'text-amber-400'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-[#151515] border border-white/5 p-4 rounded-xl flex flex-col gap-2">
