 ...
 <div className="flex flex-col gap-6 w-full font-sans text-sm pb-12">
  {showInjuryModal && player?.rehabProcess && (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
      <div className="bg-[#111111] border border-red-500/30 p-8 max-w-2xl w-full relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <button onClick={() => handleSelectTreatment('SURGERY')} className="group flex flex-col p-4 bg-white/5 border border-[#222] hover:border-red-500/50 hover:bg-white/10 text-left transition-all">
            ...
            <button onClick={() => handleSelectTreatment('CONSERVATIVE')} className="group flex flex-col p-4 bg-white/5 border border-[#222] hover:border-[#38bdf8]/50 hover:bg-white/10 text-left transition-all">
            ...
            <button onClick={() => handleSelectTreatment('INJECTION')} className="group flex flex-col p-4 bg-white/5 border border-[#222] hover:border-amber-500/50 hover:bg-white/10 text-left transition-all">
  ...
  {isDeadlineDay && (
     <div className="bg-red-900/40 border border-red-500/50 p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden shadow-[0_0_30px_rgba(239,68,68,0.15)]">
        ...
        <div className="relative z-10 bg-black/40 px-6 py-3 border border-red-500/30 text-center flex-shrink-0">
  ...
  <div className="relative overflow-hidden p-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative">
  ...
  <div className="flex items-center gap-5 relative z-10">
   ...
   <div className="relative group cursor-pointer shrink-0" onClick={() => setIsAvatarModalOpen(true)}>
    <CharacterPortrait
     ...
     showBorder={true}
    />
    <div className="absolute -bottom-1 -right-1 bg-teal-500 text-black p-1.5 rounded-full border border-black group-hover:scale-110 transition-transform">
     <Camera size={12} />
    </div>
   </div>
   ...
   <div className="flex items-center gap-3 mb-2">
    ...
    {player.loanInfo && (
    <span className="text-[10px] font-black uppercase tracking-widest bg-amber-500/10 border border-amber-500/30 text-amber-500 px-2.5 py-1 ">
  ...
  <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 relative z-10 w-full md:w-auto">
   <button
     ...
     className="bg-teal-500/20 border border-teal-500/40 hover:bg-teal-500 hover:text-black text-teal-300 px-4 py-2.5 text-[10px] font-mono font-bold uppercase tracking-wider transition-all flex items-center justify-center gap-2 cursor-pointer "
   >
     <Camera size={14} /> AVATAR STUDIO
   </button>
   <div className="flex flex-col gap-1 w-full md:w-48 glass-panel px-4 py-3 justify-center">
   ...
   <div className="flex items-center gap-4 glass-panel px-6 py-4 self-stretch md:self-auto justify-between md:justify-start">
    ...
    return (
      <div id="active_critical_alerts" className="flex flex-col gap-3">
        {criticalMessages.map((msg) => (
          <div key={msg.id} className="bg-red-500/15 border border-red-500/40 p-4 flex items-center justify-between gap-4 animate-pulse">
            ...
            <button 
              ...
              className="bg-red-500 hover:bg-red-600 text-white px-5 py-2 rounded font-mono text-[10px] font-black uppercase tracking-widest transition-all shrink-0 cursor-pointer"
            >
              Resolve Now
            </button>
          </div>
  ...
  <div className="md:col-span-2 flex flex-col gap-6">
   ...
   {state.activeEvent ? (
    <div className="premium-card border border-[#00FF88] flex-1 flex flex-col justify-center p-8 relative overflow-hidden ">
    ...
    <div className="max-w-xl w-full mx-auto text-left relative z-10">
     <div className="text-[#00FF88] text-[9px] font-black uppercase tracking-widest mb-2 border-b border-[#222] pb-2">Unexpected Incident / Choice Required</div>
     ...
     <div className="flex flex-col gap-2.5">
      ...
      <button 
       ...
       className="bg-[#181818] border border-[#2f2f2f] hover:border-[#00FF88] hover:bg-[#00FF88] hover:text-black text-white p-3.5 text-xs font-bold uppercase tracking-widest transition-all flex justify-between items-center group"
      >
     ...
     <div className="border border-[#38bdf8]/40 flex-1 flex flex-col items-center justify-center text-center p-8 relative overflow-hidden w-full">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-[#222] pb-4 mb-6 relative z-10 w-full text-left">
       <div>
       ...
       <button 
        ...
        className="bg-[#38bdf8]/10 hover:bg-[#38bdf8]/20 border border-[#38bdf8]/40 text-[#38bdf8] px-4 py-2 text-xs font-mono font-bold uppercase tracking-wider transition-all flex items-center gap-2"
       >
      ...
      <div className="mb-6 bg-[#080d12]/80 border border-[#111] p-4 sm:p-5 relative z-10 w-full">
       ...
       <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
        {(player.rehabProcess?.stages || [
         ...
         return (
          <div key={stg.id} className={`p-3 border text-left transition-all ${
           isCurrent ? 'bg-[#38bdf8]/15 border-[#38bdf8] shadow-[#38bdf8]/10' :
           isCompleted ? 'bg-emerald-950/20 border-emerald-500/40 text-emerald-400' : 'bg-[#080808] border-[#111] text-white/40'
          }`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 relative z-10 w-full text-left">
       ...
       <div className="bg-[#080d12]/90 border border-[#111] p-4 flex flex-col justify-center">
      ...
      <div className="relative z-10 bg-[#070b0f] border border-[#222] p-4 sm:p-5 w-full text-left">
       ...
       <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <button
         ...
         className="p-3.5 border border-amber-500/30 hover:border-amber-400 bg-amber-950/20 text-left transition-all group"
        >
        ...
        <button
         ...
         className="p-3.5 border border-[#38bdf8]/40 hover:border-[#38bdf8] bg-[#38bdf8]/10 text-left transition-all group"
        >
        ...
        <button
         ...
         className="p-3.5 border border-emerald-500/30 hover:border-emerald-400 bg-emerald-950/20 text-left transition-all group"
        >
     ...
     <div className="border border-zinc-800 flex-1 flex flex-col items-center justify-center text-center p-8 relative overflow-hidden w-full">
      ...
      <div className="flex flex-col sm:flex-row gap-3 relative z-10">
       <button 
        ...
        className="bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-white px-8 py-3 font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all text-xs"
       >
        Solo Workout Session <ArrowRight size={14} />
       </button>
       <button 
        onClick={() => setScreen('TRANSFERS')} 
        className="bg-[#00FF88] hover:bg-white text-black px-8 py-3 font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all text-xs shadow-[#00FF88]/10"
       >
    ...
    <div className="border border-red-900/40 flex-1 flex flex-col items-center justify-center text-center p-8 relative overflow-hidden ">
     ...
     className="bg-red-500 hover:bg-red-600 text-white px-10 py-4 font-black uppercase tracking-widest flex items-center gap-3 relative z-10 transition-colors text-xs"
     >
     Complete Fitness Drills <ArrowRight size={18} />
     </button>
    </div>
    ) : (
    <div className={`${state.nextMatch?.matchType === 'DERBY' ? 'border-red-500/50' : state.nextMatch?.matchType === 'GRUDGE' ? 'border-orange-500/50' : 'border-[#00FF88]/40'} flex-1 flex flex-col p-6 md:p-8 relative overflow-hidden `}>
     ...
     <div className="flex flex-col xl:flex-row gap-8 items-stretch w-full relative z-10">
      ...
      <div className="flex-1 flex flex-col justify-center items-center text-center xl:text-left xl:items-start border-b xl:border-b-0 xl:border-r border-[#222] pb-6 xl:pb-0 xl:pr-8">
       ...
       <button 
        ...
        className="w-full sm:w-auto bg-[#00FF88] hover:bg-[#00FF88]/90 text-black px-12 py-4 font-black uppercase tracking-widest flex items-center justify-center gap-3 transition-colors shadow-[#00FF88]/10 text-xs border-2 border-black ring-4 ring-[#00FF88]/20"
       >
        ...
        return (
         <div className="flex flex-col h-full justify-between gap-4 text-left font-mono text-xs">
          <div>
           ...
           {!studied ? (
            <div className="bg-amber-500/5 border border-amber-500/20 p-4 flex flex-col justify-center items-center text-center gap-3">
            ...
            <div className="space-y-3">
             <div className="bg-white/5 border border-[#222] p-3 ">
                ...
                <button
                 ...
                 className={`py-2 px-3 border rounded text-[10px] font-bold uppercase transition-all text-center ${
                  currentStrategy === strat.id 
                   ...
                   : 'border-[#222] bg-[#0c0c0c] text-white/50 hover:border-white/30'
                 }`}
                >
                 {strat.label}
                </button>
          ...
          {studied && (
           <div className={`p-2.5 border text-center text-[10px] font-bold uppercase tracking-widest ${
            hasCorrectCounter 
             ? 'bg-emerald-950/20 border-emerald-500/20 text-emerald-400 animate-pulse' 
             : isMismatched 
             ? 'bg-red-950/20 border-red-500/20 text-red-400' 
             : 'bg-white/5 border-[#222] text-white/50'
           }`}>
   ...
   <div className="grid grid-cols-7 gap-2">
    ...
    return (
     <div key={day} className={`p-4 border flex flex-col items-center justify-center transition-all ${
     isToday ? 'border-[#00FF88] bg-[#00FF88]/5 shadow-[0_0_20px_rgba(201,168,76,0.05)] relative scale-102 z-10' : 
     isPast ? 'border-[#1a1a1a] bg-[#0a0a0a]/50 opacity-40' : 'border-[#222] bg-[#141414] hover:border-[#222]'
     }`}>
  ...
  <div className="flex flex-col gap-6">
    ...
    {player.newManagerBounce?.active && (
     <div className="premium-card p-5 flex flex-col border border-cyan-500/30 relative overflow-hidden">
      ...
      <div className="space-y-2.5 font-mono text-xs font-semibold">
       ...
       <div className="bg-cyan-950/20 border border-cyan-500/10 p-2.5 text-[10px] space-y-1">
       ...
       <div className="text-[10px] text-white/50 pt-1">
        ...
        <div className="flex flex-wrap gap-1">
         {player.managerInfo?.valuedAttributes?.map((attr: string) => (
          <span key={attr} className="bg-white/5 border border-[#222] text-white px-2 py-0.5 rounded text-[9px] uppercase font-bold">
           {attr}
          </span>
         ))}
        </div>
    ...
    {player.seasonObjective && (
     <div className="premium-card p-5 flex flex-col border border-[#111] bg-[#0d0d0d] relative overflow-hidden">
      <div className="absolute top-0 right-0 w-24 h-24 bg-[#00FF88]/5 rounded-full blur-xl pointer-events-none"></div>
      
      <div className="flex items-center justify-between w-full mb-3 pb-2 border-b border-[#222]">
       <div className="flex items-center gap-2">
      ...
      <div className="space-y-3 font-mono text-xs">
       ...
       {(() => {
         ...
         return (
           <>
            <div className="flex justify-between items-center py-2 border-y border-[#111] mt-2">
            ...
            <div className={`mt-2 p-2.5 border text-center text-[10px] font-black uppercase tracking-wider ${statusBg} ${statusColor}`}>
             Status: {statusText}
            </div>
           </>
         );
   ...
   <h3 className="text-white text-xs font-black uppercase tracking-widest mb-6 pb-3 border-b border-[#222] flex items-center gap-2">
   ...
   <div className="mt-8 pt-4 border-t border-[#222] text-center flex flex-col gap-2">
    <button 
    onClick={() => setScreen('TRAINING')}
    className="w-full bg-[#181818] border border-[#2f2f2f] hover:border-[#00FF88] text-white py-3 text-xs font-black uppercase tracking-widest transition-colors flex items-center justify-center gap-2"
    >
   ...
   <div 
   className={`premium-card p-5 flex flex-col transition-all text-left relative overflow-hidden group ${
     isAdvanceBlocked 
   ...
   <div className="mt-3 pt-3 border-t border-[#222] flex items-center justify-between gap-2">
    <button
     onClick={() => {
      if (isAdvanceBlocked) {
       setScheduleTab('ACTIONS');
  ...
  <div className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-[#222] pb-4 mb-6 gap-4">
   <div className="flex items-center gap-3">
   ...
   <div className="flex p-1 bg-[#0a0a0a]">
   <button
  ...
  {activeFeedTab === 'MANAGER' ? (
   ...
   <div className="md:col-span-2 glass-panel p-6 flex flex-col justify-between relative overflow-hidden">
    ...
    <div className="bg-[#0e0e0e] border-l-4 border-[#00FF88] p-4 my-4 italic text-xs text-[#ccc] leading-relaxed relative font-mono">
     {getManagerVerdict(player.trust, player.isInjured).quote}
     <div className="absolute -bottom-2.5 left-6 w-3 h-3 bg-[#0e0e0e] border-r border-b border-[#222] transform rotate-45"></div>
    </div>
    </div>

    <div className="mt-4 pt-4 border-t border-[#222]/40 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
     <div>
     ...
     <div className="flex items-center gap-2">
      <button
       ...
       className="px-3 py-1.5 bg-[#00FF88] text-black font-extrabold text-[10px] uppercase tracking-wider hover:bg-[#00FF88]/90 transition-all flex items-center gap-1.5 shadow"
      >
       <MessageSquare size={12} /> Meeting
      </button>
      <button
       
       className="px-3 py-1.5 bg-amber-400 text-black font-extrabold text-[10px] uppercase tracking-wider hover:bg-amber-300 transition-all flex items-center gap-1.5 shadow"
      >
   ...
   <div className="glass-panel p-6 flex flex-col justify-between">
    ...
    <div className="space-y-4 font-mono text-xs">
     <div className="flex justify-between items-center pb-2 border-b border-[#222]/40">
   ...
   <div className="flex flex-col gap-5 w-full">
    ...
    <div className="bg-[#0b0b0b] border border-[#1e1e1e] p-5 ">
     ...
     <div className="w-full bg-[#151515] h-3 rounded-full overflow-hidden border border-[#111] p-0.5">
    ...
    {generateParodyRumors().map((rumor, i) => (
     <div key={i} className="glass-panel hover:border-[#222] p-4 flex flex-col justify-between transition-colors">
     ...
     <div className="flex gap-4 font-mono text-[9px] text-white/40 border-t border-[#222]/40 pt-2.5">
    ...
    {!state.nextMatch ? (
     ...
     return (
      <div className="space-y-6">
       <div className="flex flex-col sm:flex-row justify-between sm:items-center border-b border-[#222] pb-4 gap-4">
       ...
       {!studied ? (
        <div className="bg-[#0e0e0e] border border-[#111] p-6 text-center space-y-4">
         ...
         <button
          ...
          className="bg-[#00FF88] hover:bg-[#00FF88]/95 text-black font-mono font-bold text-xs uppercase tracking-widest px-6 py-3 transition-all"
         >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
         <div className="md:col-span-2 space-y-4">
          <div className="glass-panel p-5 border border-[#111] space-y-3">
           ...
           <div className="bg-[#00FF88]/5 border border-[#00FF88]/10 p-3 text-[11px] flex justify-between items-center font-mono">
          ...
          <div className="space-y-3">
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <button
             ...
             className={`p-4 border text-left transition-all flex flex-col justify-between h-28 font-mono ${
              currentStrategy === 'BALANCED'
               ? 'border-[#00FF88] bg-[#00FF88]/5'
               : 'border-[#111] bg-[#0e0e0e] hover:border-[#333]'
             }`}
            >
             <div>
         ...
         <div className="space-y-4 w-full">
          <div className="bg-[#0a0a0a] border border-[#111] p-5 space-y-4 font-mono">
           ...
           <div className="bg-[#0e0e0e] p-3 rounded text-[10px] text-white/50 leading-relaxed border border-[#111]">
            {currentStrategy === 'BALANCED' ? (
