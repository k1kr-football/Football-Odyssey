...
export const BACKSTORIES: Record<BackstoryType, BackstoryConfig> = {
  ...
  WONDERKID: {
    ...
    nationalityPool: ['Brazil', 'England', 'Spain', 'France', 'Argentina', 'Germany', 'Portugal'],
    attributeDistribution: {
      pace: 82,
      strength: 65,
      stamina: 70,
  ...
  NEPOTISM_CASE: {
    ...
    nationalityPool: ['England', 'France', 'Spain', 'Italy', 'Netherlands', 'Brazil', 'Argentina'],
    attributeDistribution: {
      pace: 68,
      strength: 54,
      stamina: 62,
  ...
  THE_REFUGEE: {
    ...
    nationalityPool: ['Ukraine', 'Syria', 'Somalia', 'Sudan', 'Afghanistan', 'DR Congo', 'Colombia'],
    attributeDistribution: {
      pace: 78,
      strength: 65,
      stamina: 82,
  ...
  LATE_REPLACEMENT: {
    ...
    nationalityPool: ['England', 'Germany', 'Spain', 'France', 'Italy', 'Portugal'],
    attributeDistribution: {
      pace: 62,
      strength: 60,
      stamina: 64,
  ...
  SECOND_SPORT_CONVERT: {
    ...
    nationalityPool: ['United States', 'Ireland', 'Australia', 'England', 'Jamaica', 'South Africa', 'New Zealand', 'France'],
    attributeDistribution: {
      pace: 88,
      strength: 86,
      stamina: 85,
